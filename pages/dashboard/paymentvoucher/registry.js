...
export default function Registry({statevalues,setstatevalues, searching }) {
  ...
  return (
    <div className='container'>
         ...
         <div className='container px-16 py-3 bg-grayshade5 flex flex-row items-center justify-start'>
            <h2 className='font-bold  text-lg mr-60 uppercase'>Dashboard</h2>
        </div>
        ...
        <div className='h-screen px-16 mt-6  w-full overflow-auto'>
            ...
            <button onClick={()=>dashboardvalue(2)} className='pb-[45px] pt-5'>
            <div className='bg-black shadow-lg hover:scale-110 transition-all ease-in-out cursor-pointer duration-300 flex flex-row items-center justify-center rounded-lg p-10 mx-6'>

             <p className='text-white'>Enroll Company</p>

             <FontAwesomeIcon icon={faBuilding} className='w-6 h-6 text-white rounded-full overflow-hidden mx-2'/>

              </div>
              </button>

             <button onClick={()=>dashboardvalue(11)} className='pb-[45px] pt-5'>
            <div className='bg-black shadow-lg hover:scale-110 transition-all ease-in-out cursor-pointer duration-300 flex flex-row items-center justify-center rounded-lg p-10 mx-6'>

             <p className='text-white'>Add Contacts</p>

             <FontAwesomeIcon icon={faAddressCard} className='w-6 h-6 text-white rounded-full overflow-hidden mx-2'/>
             ...
             <button onClick={()=>dashboardvalue(3)} className='pb-[45px] pt-5'>
            <div className='bg-black shadow-lg hover:scale-110 transition-all ease-in-out cursor-pointer duration-300 flex flex-row items-center justify-center rounded-lg p-10 mx-6'>
